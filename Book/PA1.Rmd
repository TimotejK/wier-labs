...
Implement a web crawler that will crawl only *.gov.si* web sites. You can choose a programming language of your choice. As a set of initial seed URLs use the following URLs:

* *evem.gov.si*
* *e-uprava.gov.si*
* *podatki.gov.si*
* *e-prostor.gov.si*
* Add additional 5 other *.gov.si* URLs.
...
>
> During your assignment you should crawl these web sites listed above in a similar time. But when crawling also other 5 web sites of your choice and with broader limitation to all *.gov.si* domains, it will take significantly more time.
